"""Plot the GWAS standard figures."""
...
def run(
    ...
    gwas_df, _ = load_gwas_results(results)
    return plot_gwas_results(gwas_df, plots, dry_run=dry_run)


def main() -> None:
    parser = argparse.ArgumentParser(description="Plot the GWAS standard figures.")
