...
def run(
    ...
    print_utility_plot_hint("utility_standard", results, "utility_df_full.csv")
    return []


def main() -> None:
    parser = argparse.ArgumentParser(description="Report the utility standard CSV location.")
