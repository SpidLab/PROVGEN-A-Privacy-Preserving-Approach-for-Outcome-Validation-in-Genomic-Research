"""Plot the large-scale MIA figures."""
...
def run(
    ...
    _, mia_large_df = load_mia_results(results)
    return plot_mia(mia_large_df, plots, large_scale=True, dry_run=dry_run)


def main() -> None:
    parser = argparse.ArgumentParser(description="Plot the large-scale MIA figures.")
